<template>
   <ModalLayout title="Add New Budget"
      ...
      <Form @submit="onSubmit" :validation-schema="schemas.addNewBudgetSchema">
         <div class="flex flex-col gap-y-4">
            <SelectInput :options="categoryList" name="category" key-prop="category" label-prop="category"
               label="Budget Category" />
            <TextInput is-amount name="maximum" label="Maximum spend" placeholder="e.g. 2000" />
            <SelectInput :options="theme" name="theme" key-prop="theme" label-prop="theme" label="Theme" />
         </div>
